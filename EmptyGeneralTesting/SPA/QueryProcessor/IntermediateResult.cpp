...
[p] - empty vector 
*/
void IntermediateResult::Initialize(const std::vector<Synonym> synonyms)
{
	
	for(std::vector<Synonym>::const_iterator it = synonyms.begin(); it != synonyms.end(); ++it)
	{
		SynonymType type = it->type;
