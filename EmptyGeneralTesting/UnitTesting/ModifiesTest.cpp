...
void ModifiesTest::TestSingleStmt() {
	...
	vector<unsigned int> stmtsModifyingVar0 = Modifies::GetStmtModifyingVar(0);
	CPPUNIT_ASSERT(stmtsModifyingVar0.size() == 1);
	CPPUNIT_ASSERT(stmtsModifyingVar0[0] == 1);

	vector<unsigned int> varsModifiedByStmt1 = Modifies::GetVarModifiedByStmt(1);
...
void ModifiesTest::TestMultipleStmts() {
	...
	vector<unsigned int> stmtsModifiesVar0 = Modifies::GetStmtModifyingVar(0);
	CPPUNIT_ASSERT(stmtsModifiesVar0.size() == 1);
	CPPUNIT_ASSERT(stmtsModifiesVar0[0] == 1);

	vector<unsigned int> stmtsModifiesVar1 = Modifies::GetStmtModifyingVar(1);
	CPPUNIT_ASSERT(stmtsModifiesVar1.size() == 1);
	CPPUNIT_ASSERT(stmtsModifiesVar1[0] == 2);

	vector<unsigned int> stmtsModifiesVar2 = Modifies::GetStmtModifyingVar(2);
	CPPUNIT_ASSERT(stmtsModifiesVar2.size() == 1);
	CPPUNIT_ASSERT(stmtsModifiesVar2[0] == 3);

	vector<unsigned int> stmtsModifiesVar3 = Modifies::GetStmtModifyingVar(3);
	...
	vector<unsigned int> varsModifiedByStmt2 = Modifies::GetVarModifiedByStmt(2);
	CPPUNIT_ASSERT(varsModifiedByStmt2.size() == 1);
	CPPUNIT_ASSERT(varsModifiedByStmt2[0] == 1);

	vector<unsigned int> varsModifiedByStmt3 = Modifies::GetVarModifiedByStmt(3);
	CPPUNIT_ASSERT(varsModifiedByStmt3.size() == 1);
	CPPUNIT_ASSERT(varsModifiedByStmt3[0] == 2);

	vector<unsigned int> varsModifiedByStmt4 = Modifies::GetVarModifiedByStmt(4);
...
void ModifiesTest::TestSingleStmtModifyingMultipleVars() {
	...
	vector<unsigned int> stmtsModifyingVar1 = Modifies::GetStmtModifyingVar(1);
	CPPUNIT_ASSERT(stmtsModifyingVar1.size() == 1);
	CPPUNIT_ASSERT(stmtsModifyingVar1[0] == 1);

	vector<unsigned int> stmtsModifyingVar2 = Modifies::GetStmtModifyingVar(2);
	CPPUNIT_ASSERT(stmtsModifyingVar2.size() == 1);
	CPPUNIT_ASSERT(stmtsModifyingVar2[0] == 1);

	vector<unsigned int> stmtsModifyingVar3 = Modifies::GetStmtModifyingVar(3);
...
void ModifiesTest::TestModifies() {
	...
	vector<unsigned int> stmtsModifyingVar4 = Modifies::GetStmtModifyingVar(4);
	CPPUNIT_ASSERT(stmtsModifyingVar4.size() == 1);
	CPPUNIT_ASSERT(stmtsModifyingVar4[0] == 5);

	vector<unsigned int> stmtsModifyingVar15 = Modifies::GetStmtModifyingVar(15);
	...
	vector<unsigned int> varsModifiedByStmt5 = Modifies::GetVarModifiedByStmt(5);
	CPPUNIT_ASSERT(varsModifiedByStmt5.size() == 1);
	CPPUNIT_ASSERT(varsModifiedByStmt5[0] == 4);

	vector<unsigned int> varsModifiedByStmt10 = Modifies::GetVarModifiedByStmt(10);
